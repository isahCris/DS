	...
	public Calculadora () {
		...
		btSubtrair.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(null, "O resultado da subtra��o �:  " + (num1 - num2));
			}
		});
		...
		btMult.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(null, "O resultado da multiplica��o �:  " + (num1 * num2));
			}
		});
		...
		btDiv.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (num2 == 0) {
					...
					JOptionPane.showMessageDialog(null, "N�o � possivel fazer o calculo!  (um numero n pode ser dividido por 0)");
					
				} else {
					
					JOptionPane.showMessageDialog(null, "O resultado da divis�o �:  " + (num1 / num2));
				}
